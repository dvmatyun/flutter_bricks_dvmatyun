...
class SocketMessageImpl extends Equatable implements ISocketMessage<dynamic> {
  @override
  ...
  SocketMessageImpl.trio({
    ...
    this.data,
        ...
        topic = SocketTopicImpl.trio(host: host, topic1: topic1, topic2: topic2);

  factory SocketMessageImpl.fromJson(Map<String, dynamic> json) => _$SocketMessageImplFromJson(json);

  Map<String, dynamic> toJson() => _$SocketMessageImplToJson(this);

  @override
  List<Object?> get props => [topic, data, error];
}
...
class WebSocketTypedMessage<T> {
  ...
  WebSocketTypedMessage({required ISocketMessage webSocketMessage, required this.data}) {
